    ...
    try:
        ...
        response = requests.post(
            ...
            json={
                "model": MODEL,
                "messages": [
                    {"role": "system", "content": "تو یک دستیار هوش مصنوعی به نام MiMo (میمو) هستی که توسط شیائومی (Xiaomi) ساخته شدی. به فارسی جواب بده. هیچوقت نگو که Claude یا هر مدل دیگه‌ای هستی!"},
